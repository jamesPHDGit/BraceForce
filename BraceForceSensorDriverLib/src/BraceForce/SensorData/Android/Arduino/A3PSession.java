...
public class A3PSession {
	...
	private AndroidSubChannel arduinoChannel;
...
//	private static final int CONFIG_DEVICE_ID = 0;
	...
	public A3PSession(AndroidSubChannel myChannel, ParcelFileDescriptor parcelFileDescriptor){//InputStream inputStream, OutputStream outputStream){
