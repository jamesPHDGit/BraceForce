 ...
 * 
 */
public class AndroidBluetoothSensor extends Thread {
	 ...
	 */
	public AndroidBluetoothSensor(AndroidSensorLinkManager sensor, BluetoothDevice device,
			AndroidBluetoothManager btManager) {
...
//				}
				...
				AndroidSensorDataPacket sdp = new AndroidSensorDataPacket(sdpbuff,
