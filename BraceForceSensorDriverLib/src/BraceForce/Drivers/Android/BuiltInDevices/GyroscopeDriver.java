...
public class GyroscopeDriver extends AbstractBuiltinDriver {
	...
	public GyroscopeDriver() {
		sensorParams.add(new AndroidSensorParameter(X_AXIS, AndroidSensorParameter.Type.FLOAT, AndroidSensorParameter.Purpose.DATA, "Rate of rotation around the x axis."));
		sensorParams.add(new AndroidSensorParameter(Y_AXIS, AndroidSensorParameter.Type.FLOAT, AndroidSensorParameter.Purpose.DATA, "Rate of rotation around the y axis."));
		sensorParams.add(new AndroidSensorParameter(Z_AXIS, AndroidSensorParameter.Type.FLOAT, AndroidSensorParameter.Purpose.DATA, "Rate of rotation around the z axis."));
