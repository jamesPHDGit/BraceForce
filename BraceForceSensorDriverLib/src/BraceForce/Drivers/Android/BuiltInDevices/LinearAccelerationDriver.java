...
public class LinearAccelerationDriver extends AbstractBuiltinDriver {
	...
	public LinearAccelerationDriver() {
		sensorParams.add(new AndroidSensorParameter(X_AXIS, AndroidSensorParameter.Type.FLOAT, AndroidSensorParameter.Purpose.DATA, "Acceleration force along the x axis (excluding gravity)."));
		sensorParams.add(new AndroidSensorParameter(Y_AXIS, AndroidSensorParameter.Type.FLOAT, AndroidSensorParameter.Purpose.DATA, "Acceleration force along the y axis (excluding gravity)."));
		sensorParams.add(new AndroidSensorParameter(Z_AXIS, AndroidSensorParameter.Type.FLOAT, AndroidSensorParameter.Purpose.DATA, "Acceleration force along the z axis (excluding gravity)."));
