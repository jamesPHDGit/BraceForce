...
public class AccelerometerDriver extends AbstractBuiltinDriver {
	...
	public AccelerometerDriver() {
		sensorParams.add(new AndroidSensorParameter(X_AXIS, AndroidSensorParameter.Type.FLOAT, AndroidSensorParameter.Purpose.DATA, "X axis reading of accelerometer"));
		sensorParams.add(new AndroidSensorParameter(Y_AXIS, AndroidSensorParameter.Type.FLOAT, AndroidSensorParameter.Purpose.DATA, "Y axis reading of accelerometer"));
		sensorParams.add(new AndroidSensorParameter(Z_AXIS, AndroidSensorParameter.Type.FLOAT, AndroidSensorParameter.Purpose.DATA, "Z axis reading of accelerometer"));
